...
- [ai_skill_authoring](./skills/ai_skill_authoring/SKILL.md): creating, reviewing, consolidating, and maintaining SKILL.md, AGENTS.md, CLAUDE.md, Copilot, Cursor, and repository instruction files.
